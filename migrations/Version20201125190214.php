 ...
 */
final class Version20201125190214 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE cliente ADD CONSTRAINT FK_F41C9B25766B17C9 FOREIGN KEY (doc_referente_id) REFERENCES doctor (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
