 ...
 */
final class Version20220511124022 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE evolucion (id INT AUTO_INCREMENT NOT NULL, paciente_id INT NOT NULL, tipo VARCHAR(255) NOT NULL, fecha DATETIME NOT NULL, user LONGTEXT NOT NULL, description LONGTEXT NOT NULL, adjunto_url LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:array)\', INDEX IDX_8FC247B57310DAD4 (paciente_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE historia_egreso (id INT AUTO_INCREMENT NOT NULL, cliente_id INT NOT NULL, epicrisis_alta LONGTEXT DEFAULT NULL, fecha DATETIME NOT NULL, INDEX IDX_750F6B60DE734E51 (cliente_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE notas_historia_clinica (id INT AUTO_INCREMENT NOT NULL, user_id_id INT NOT NULL, cliente_id INT DEFAULT NULL, text VARCHAR(1024) NOT NULL, fecha DATE NOT NULL, INDEX IDX_A1A5A1F49D86650F (user_id_id), INDEX IDX_A1A5A1F4DE734E51 (cliente_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE recibo (id INT AUTO_INCREMENT NOT NULL, tipo VARCHAR(255) NOT NULL, fecha DATE NOT NULL, count INT NOT NULL, html LONGTEXT NOT NULL, cid INT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE tipo_consumible (id INT AUTO_INCREMENT NOT NULL, nombre VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_1047DA523A909126 (nombre), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE historia_ingreso ADD CONSTRAINT FK_39753380DE734E51 FOREIGN KEY (cliente_id) REFERENCES cliente (id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE evolucion DROP FOREIGN KEY FK_8FC247B57310DAD4');
        $this->addSql('ALTER TABLE historia_egreso DROP FOREIGN KEY FK_750F6B60DE734E51');
        $this->addSql('ALTER TABLE historia_habitaciones DROP FOREIGN KEY FK_5A3F4F8EDE734E51');
        $this->addSql('ALTER TABLE historia_ingreso DROP FOREIGN KEY FK_39753380DE734E51');
        ...
        $this->addSql('ALTER TABLE notas_historia_clinica DROP FOREIGN KEY FK_A1A5A1F49D86650F');
        ...
        $this->addSql('DROP TABLE historia_ingreso');
